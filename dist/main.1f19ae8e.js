...
thisYear.textContent = new Date().getFullYear(); //to-top
...
var projectsEl = document.querySelector("#menu-projects");
...
var strategyEl = document.querySelector("#menu-strategy");
